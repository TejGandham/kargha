...
def main() -> None:
    ...
    parser.add_argument("--out", default="kargha-validate-capture.json")
    parser.add_argument("--artifacts-dir", default=".kargha-validate")
    parser.add_argument("--viewport", default="1440x900", type=parse_viewport)
    parser.add_argument("--session", default="kargha-validate")
    ...
    result: dict[str, Any] = {
        "schema": "kargha.validate.capture.v1",
