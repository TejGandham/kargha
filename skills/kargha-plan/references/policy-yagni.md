...
Loaded by `kargha-plan` with `ci-policy.md` when planning frontend-adjacent CI, GitHub Actions, repository automation, branch policy, rulesets, required checks, deployment policy, generated contracts, or environment policy work.
